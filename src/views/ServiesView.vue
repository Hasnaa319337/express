...
.servies {
  ...
  h2 {
    ...
    margin-bottom: 70px;
    color: #150f4e;
    border-bottom: 3px solid #150f4e;
  ...
  .courses_type2,
  .courses_type3,.courses_type6 {
    margin-bottom: 20px;

    text-align: center;
    background: url("../assets/images/port-1845350_640.jpg");
